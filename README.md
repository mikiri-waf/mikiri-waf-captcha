...
```bash
apt update && apt install -y nginx python3 python3-venv python3-pip memcached git
...
cp /var/www/mikiri-waf-captcha/misc/mikiri-waf-captcha /etc/logrotate.d/
cp /var/www/mikiri-waf-captcha/misc/mikiri-waf-captcha.service /lib/systemd/system/
```
...
4. Check status and log for errors:
